...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            if (opc.equals("1")) cadastrarEspetaculo();
            else if (opc.equals("2")) cadastrarCliente();
            else if (opc.equals("3")) compraDeEntradas();
            else if (opc.equals("4")) {
                System.out.println("Saindo...");
                return;
            } else System.out.println("Opção inválida. Escolha entre 1 e 4.\n");
        }
    }
